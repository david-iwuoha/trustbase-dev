...
/// Implements the Nigerian Trust Palette with Transparent Authority design style.
class AppTheme {
  AppTheme._();

  // Nigerian Trust Palette - Core Colors
  static const Color primaryLight =
      Color(0xFF0F766E); // Deep teal for trust and authority
  static const Color primaryVariantLight =
      Color(0xFF0D9488); // Lighter teal variant
  static const Color secondaryLight =
      Color(0xFFF59E0B); // Warm amber for accent actions
  static const Color secondaryVariantLight =
      Color(0xFFD97706); // Deeper amber variant
  static const Color backgroundLight =
      Color(0xFFFAFAFA); // Soft neutral for eye strain reduction
  static const Color surfaceLight =
      Color(0xFFFFFFFF); // Pure white for content cards
  static const Color errorLight =
      Color(0xFFDC2626); // High contrast for mobile visibility
  static const Color successLight = Color(0xFF059669); // Consent granted state
  static const Color warningLight =
      Color(0xFFD97706); // Attention states for consent reviews
  ...
  static const Color primaryDark =
      Color(0xFF14B8A6); // Brighter teal for dark mode
  static const Color primaryVariantDark = Color(0xFF0F766E);
  ...
  // Semantic colors for status-driven design
  static const Color borderLight =
      Color(0xFFE5E7EB); // Subtle definition used sparingly
  ...
  static const Color textSecondaryLight =
      Color(0xFF6B7280); // Mid-gray for supporting information
  ...
  static const Color glassLight =
      Color(0x0AFFFFFF); // Subtle transparency for glassmorphism
  static const Color glassDark = Color(0x0A000000);

  /// Light theme with Nigerian Trust Palette
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme with transparent authority
    ...
    // Floating action button with contextual appearance
    ...
    // Button themes with confident interaction
    ...
    // Input decoration with focus states
    ...
    // Switch theme for consent toggles
  ...
  /// Dark theme with Nigerian Trust Palette
